 ...
 * "Bioluminescent Deep" — glowing surface arc, floating bio-orbs,
 * bold CTA band, glass link columns, inline newsletter.
 *
...
<!-- ============================================
     FOOTER — Bioluminescent Deep
     ============================================ -->
<footer id="site-footer">
    <!-- glowing surface curve (looking up at the water from the deep) -->
    <div class="footer-surface" aria-hidden="true"></div>
    <!-- bio-luminescent floating orbs -->
    <span class="footer-orb footer-orb--1" aria-hidden="true"></span>
    <span class="footer-orb footer-orb--2" aria-hidden="true"></span>
    <span class="footer-orb footer-orb--3" aria-hidden="true"></span>
    ...
    <div class="footer-inner">
        ...
        <div class="footer-bottom">
            <div>
                <p class="footer-copy">&copy; <?php echo esc_html(date_i18n('Y')); ?> Ocean Alliance Network · A 501(c)(3) nonprofit.</p>
            ...
            <form class="footer-mini-form" onsubmit="return false;">
                <input type="email" placeholder="Join the newsletter" aria-label="Email address" required />
