...
<section class="page-hero">
    <div class="page-hero-video" aria-hidden="true">
        <iframe src="https://www.youtube-nocookie.com/embed/tADnCEpbPI8?autoplay=1&mute=1&start=6195&loop=1&playlist=tADnCEpbPI8&controls=0&showinfo=0&modestbranding=1&rel=0&iv_load_policy=3&playsinline=1&disablekb=1" title="" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    </div>
