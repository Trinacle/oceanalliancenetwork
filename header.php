...
<div class="marine-life" aria-hidden="true">
    ...
    <!-- ZONE 1b: extra shallow creature -->
    <img class="creature c-extra1" src="<?php echo esc_url($creature_uri); ?>/1024x411.png" alt="" data-dir="right" />

    <!-- ZONE 2: mid-water (40-110vh) -->
    ...
    <!-- ZONE 2b: extra mid-water creature -->
    <img class="creature c-extra2" src="<?php echo esc_url($creature_uri); ?>/1024x317.png" alt="" data-dir="right" />
    <svg class="creature creature--fish fish-e" viewBox="0 0 120 60" data-dir="right">
        <path d="M5 30 Q15 18 28 30 Q15 42 5 30 Z M28 30 L36 26 L36 34 Z" fill="currentColor"/>
        <path d="M44 22 Q54 10 67 22 Q54 34 44 22 Z M67 22 L75 18 L75 26 Z" fill="currentColor"/>
        <path d="M82 36 Q92 24 105 36 Q92 48 82 36 Z M105 36 L113 32 L113 40 Z" fill="currentColor"/>
    </svg>

    <!-- ZONE 3: deep (110-210vh) -->
    ...
    <!-- ZONE 3b: extra deep creatures -->
    <img class="creature c-extra3" src="<?php echo esc_url($creature_uri); ?>/1024x623.png" alt="" data-dir="left" />
    <img class="creature c-extra4" src="<?php echo esc_url($creature_uri); ?>/1024x503.png" alt="" data-dir="right" />
    ...
    <!-- ZONE 4b: extra abyss creatures + fish -->
    <img class="creature c-extra5" src="<?php echo esc_url($creature_uri); ?>/1024x653.png" alt="" data-dir="right" />
    <svg class="creature creature--fish fish-f" viewBox="0 0 120 60" data-dir="right">
        <path d="M5 30 Q15 18 28 30 Q15 42 5 30 Z M28 30 L36 26 L36 34 Z" fill="currentColor"/>
        <path d="M44 22 Q54 10 67 22 Q54 34 44 22 Z M67 22 L75 18 L75 26 Z" fill="currentColor"/>
    </svg>
</div>
